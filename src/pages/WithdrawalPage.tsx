...
const WithdrawalPage = () => {
  ...
  const currentBalanceINR = profile ? Math.floor(profile.totalCredits / CONVERSION_RATE) : 0;
  const canWithdraw = profile && profile.totalCredits >= MIN_WITHDRAWAL && profile.bankDetails;
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  <h3 className="text-6xl font-black text-slate-900 tracking-tighter drop-shadow-sm">{profile?.totalCredits || 1000}</h3>
