    ...
    <div className="max-w-5xl mx-auto space-y-8 relative pb-24">
      ...
      <div className="glass-card rounded-3xl border border-white/40 shadow-xl overflow-hidden bg-white/40 backdrop-blur-xl">
        ...
        <div className="px-12 pb-12 relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-8 border-t border-slate-200/50">
            {[
              { label: 'Restorations Verified', value: submissions.filter(s => s.blockchainVerified).length, icon: Leaf, color: 'text-emerald-500' },
